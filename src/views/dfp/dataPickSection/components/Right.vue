<template>
    <div class="main">
        <div class="header">
            <div class="header-title">区段运行效率</div>
        </div>
        ...
        <div class="header">
            <div class="header-title">不同班次区段运行效率</div>
        </div>
        <div class="item2">
            <div class="item-content">
                <div class="select">
...
// import { getSegmentEfficiency, getSegmentEfficiency2 } from '@/api/section'
...
import { right1Json, right2Json } from '../data'
function getTopData () {
    topData.value = right1Json
    updateTopChartOptions()
    // topLoading.value = true
    // topChart.showLoading({ text: '正在加载数据...', color: '#00ffec', textColor: '#fff', maskColor: 'rgba(255, 255, 255, 0.1)' })
    // getSegmentEfficiency({ weekStartDate: topWeek.value })
    //     .then((res) => {
    //         if (res.code === 200) {
...
function getBottomData () {
    bottomData.value = right2Json
    updateBottomChartOptions()
    // bottomLoading.value = true
    // bottomChart.showLoading({ text: '正在加载数据...', color: '#00ffec', textColor: '#fff', maskColor: 'rgba(255, 255, 255, 0.1)' })
    // getSegmentEfficiency2({ weekStartDate: bottomWeek.value, shift: selectedDevice.value })
    //     .then((res) => {
    //         if (res.code === 200) {
...
const color = ['#00F0D8', '#BF7E15', '#03A735', '#00A2FF']
// 提取图表配置为函数
