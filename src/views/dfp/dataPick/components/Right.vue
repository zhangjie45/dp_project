<template>
    <div class="main">
        <div class="header">
            <div class="header-title">三楼机台({{ props.thirdFloorData.areaCount }}台)</div>
        </div>
            ...
            <div class="item-content">
                ...
                <div class="item-content-body">
                    <div class="item-content-body-item" @click="props.goDetail(item)"
                        ...
                        v-for="(item, index) in props.thirdFloorData.itemList || 0">
        ...
        <div class="header">
            <div class="header-title">C区机台({{ props.areaCData.areaCount }}台)</div>
        </div>
        <div class="item2">
            <div class="item-content">
                <div class="item-content-header">
                ...
                <div class="item-content-body">
                    <div class="item-content-body-item" @click="props.goDetail(item)"
                        :class="item.status === 2 ? 'on' : 'off'"
                        v-for="(item, index) in props.areaCData.itemList || 0">
                        <div class="txt">{{ item.machineCode }}#</div>
                        <div class="txt">{{ item.status === 2 ? '正常' : '停机' }}</div>
                        <!-- <div class="txt">{{ formatDisplayValue(item.tension) }}</div> -->
                        <div class="txt">{{ formatDisplayValue(item.lineSpeed) }}</div>
