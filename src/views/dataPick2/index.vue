        ...
        <div class="container-content">
            <div class="top">
                <div class="count-base">
                    <div class="com-count-title">标题一</div>
                ...
                <div class="count-resource q1">
                    <div class="com-count-title">标题二</div>
                    <div class="com-screen-content2">
                        ...
                        <div class="com-screen-content">
                            <div id="main2" style="margin-top: 10px; width: 100%; height: 240px">
                                <Model2 />
                            </div>
                        </div>
                        <span class="left-top"></span>
                ...
                <div class="count-resource q2">
                    <div class="com-count-title">标题三</div>
            ...
            <div class="mid">
                <div class="count-share w1">
                    <div class="com-count-title">标题四</div>
                    <div class="com-screen-content">
                        <Model4 />
                    </div>
                    <span class="left-top"></span>
                ...
                <div class="count-share w2">
                    <div class="com-count-title">标题五</div>
                    <div class="com-screen-content">
            ...
            <div class="bottom">
                <div class="count-topic e1">
                    <div class="com-count-title">标题六</div>
                    <div class="com-screen-content">
                ...
                <div class="count-topic e2">
                    <div class="com-count-title">标题七</div>
                    <div class="com-screen-content">
...
.body {
    background: #081325 url('@/assets/image/dfp/dataPick2images/interact.png') center no-repeat;
...
.count-base {
    ...
    width: 32%;
    height: 350px;
    background: url('@/assets/image/dfp/dataPick2images/left-top3.jpg') center no-repeat;
    background-size: cover;
}
...
.count-share {
    ...
    width: 48.4%;
    height: 350px;
    background: url('@/assets/image/dfp/dataPick2images/left-bottom2.jpg') center no-repeat;
    background-size: cover;
}
...
.data-label li.active {
    color: #fff;
    background: url('@/assets/image/dfp/dataPick2images/choose-item.png') center no-repeat;
}
...
.use-data {
    ...
    margin-top: 3%;
    height: 5%;
    background: url('@/assets/image/dfp/dataPick2images/resource-use-data.jpg') center no-repeat;
    background-size: cover;
